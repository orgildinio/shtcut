...
const Template_2 = ({
    ...
    return (
        <div
            style={{ border: `3px solid ${activeTemplate === 'template_2' ? presetColor : '#DCE5FB'}` }}
            className={` h-80 w-full cursor-pointer border-[3px] flex items-center justify-center px-4 rounded-md  `}
                ...
                <section className="absolute top-20 flex flex-col gap-2 z-40 p-2">
                    ...
                    <section className="flex  gap-2 w-full ">
                        {contactActions.map((_c) => (
                            <Card
                                style={{ border: `1px solid ${presetColor}`, backgroundColor: presetColor }}
