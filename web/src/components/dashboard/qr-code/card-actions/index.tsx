...
const CardsActions = ({ onClickDownload }: { onClickDownload: () => void }) => {
    return (
        <div>
            <div className="flex items-center gap-x-3">
                ...
                <div
                    className="bg-primary-0 border flex w-[110px] rounded h-8 text-white items-center p-[6px] gap-x-2 font-medium text-xs "
