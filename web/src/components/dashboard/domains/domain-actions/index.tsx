    ...
    return (
        <div className="flex items-center gap-x-6">
            <div className="flex items-center gap-x-2">
                ...
                <div
                    className={
                        'text-xs cursor-pointer flex mx-auto items-center w-[83px] justify-center text-[#CC7914] rounded h-[34px] bg-[#FFF3E5]  font-semibold border gap-x-1 border-[#F4C790]'
                    }
                >
                    {domainsData?.verified ? (
                        <>
                            <Loader size={16} /> <span>Verified</span>
                        </>
                    ) : (
                        <>
